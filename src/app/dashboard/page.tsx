      ...
      <div className="card bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/10 shadow-sm">
        <div className="card-body">
          ...
          <p className="text-sm text-base-content/60 mb-4">
            Connect your own bot to receive daily sparks
          </p>
            ...
            <>
              <div className="flex gap-2 mb-3">
                <button
                  ...
                  className={`btn flex-1 gap-2 ${selectedPlatform === 'telegram' ? 'btn-primary' : 'btn-outline'}`}
                >
                ...
                <button
                  ...
                  className={`btn flex-1 gap-2 ${selectedPlatform === 'whatsapp' ? 'btn-primary' : 'btn-outline'}`}
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
