 ...
 *
 * Disconnects and removes the WhatsApp configuration for the authenticated user.
 */
...
export async function POST(req: NextRequest) {
    try {
        ...
        try {
            await messagingService.stopChannel(userId, 'whatsapp');
        } catch (error) {
            console.error('Error stopping WhatsApp channel:', error);
        }
